...
import { Container, Content, Text, Button, Toast, Root  } from 'native-base';
...
export default class Home_screen extends Component {
    ...
    render() {
        return (
            <Root>
            <Container>
                {/* {console.warn(this.state.dataProducts)} */}
                <Content style={{ backgroundColor: '#f4f7f6' }}>
                    <Grid style={{ flexWrap: 'wrap', }}>
                        <Col style={{ width: deviceWidth / 2 - 10, margin: 5 }}><Text style={{ fontWeight: '500', marginBottom: 8, marginTop: 8, fontSize: 18, color: '#767676' }}>FEATURED</Text></Col>
                            <Col style={{ width: deviceWidth / 2 - 10, alignContent: 'flex-end', margin: 5 }}><Text style={{ fontWeight: '500', marginBottom: 8, marginTop: 8, fontSize: 18, textAlign: 'right', color: "#FF5A09" }} onPress={()=>(this.props.navigation.navigate("Cart"))}>GO TO CART</Text></Col>
                    </Grid>
                            ...
                            <Col key={index} style={{ borderWidth: 1, borderColor: '#CCC', width: deviceWidth / 3 - 10, margin: 5 }}>
                                ...
                                <Row style={{ padding: 5, backgroundColor: 'white' }}>
                                    <Col>
                                        ...
                                        <Row style={{ marginTop: 15, }}>
                                            <Button style={{ height: 30, backgroundColor: '#FF5A09', width:"100%" }} title="Add to cart"
                                                onPress={() => {
